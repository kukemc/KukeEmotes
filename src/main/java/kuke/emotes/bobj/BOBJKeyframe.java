...
/**
 * BOBJ keyframe — one {@code kf} line of an animation channel.
 *
 * <p>Ported from McHorse's Emoticons ({@code mchorse.emoticons.skin_n_bones.api.bobj.BOBJKeyframe},
 * GPL-3.0); only the McLib/Minecraft helper calls were swapped for {@link Interpolations}.
 */
public class BOBJKeyframe {
    ...
    /** Parse a keyframe from a BOBJ line of tokens. */
    ...
    public enum Interpolation {
        ...
        BEZIER {
            ...
            public float interpolate(BOBJKeyframe keyframe, float x, BOBJKeyframe next) {
                ...
                e = Math.max(Math.min(e, 1 / h * e), 0.00001F);
                x1 = Interpolations.clamp(x1, 0, 1);
                x2 = Interpolations.clamp(x2, 0, 1);
